    ...
    <div class="page-container">
        ...
        <table class="header">
            <tr>
                ...
                <td style="width: 50%; text-align: right;">
                    ...
                    <div class="doc-meta">
                        <strong style="color: #111; font-size: 14px;">{{ $delivery->reference_no }}</strong><br>
        ...
        <table class="info-section">
            <tr>
                <td style="padding-right: 20px;">
                    <div class="info-title">Dispatch Information</div>
                    <div class="info-content">Scheduled: {{ $delivery->scheduled_date ? \Carbon\Carbon::parse($delivery->scheduled_date)->format('M d, Y') : 'N/A' }}</div>
                    <div class="status">{{ $delivery->status }}</div>
                </td>
                <td style="padding-left: 20px;">
                    <div class="info-title">Customer Details</div>
                    <div class="info-content">{{ $delivery->customer_name ?? 'N/A' }}</div>
                    <div class="info-sub">Shipping destination verified.</div>
                </td>
            </tr>
        </table>

        <!-- ITEMS -->
        <div class="items-heading">Dispatch Line Items</div>
        <table class="items-table">
            ...
            <tbody>
                ...
                @endforeach
                <tr class="total-row">
                    <td colspan="4" class="text-right" style="color: #666666; font-size: 10px; letter-spacing: 1px;">TOTAL QUANTITY DISPATCHED</td>
        ...
        <table class="signatures">
            <tr>
                <td>
                    ...
                    <div class="sig-title">Warehouse Manager Authorized Signature</div>
                </td>
                <td>
                    <div class="sig-line"></div>
                    <div class="sig-title">Receiver Authorized Signature</div>
                </td>
            </tr>
        </table>
    </div>
