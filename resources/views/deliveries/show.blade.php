...
<div class="fade-in">
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a href="{{ route('deliveries.pdf', $delivery) }}" class="btn btn-outline-primary d-flex align-items-center gap-2 fw-bold" style="height: 48px; border-radius: 10px;" target="_blank">
