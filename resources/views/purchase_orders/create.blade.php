...
<div class="fade-in">
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            ...
            <h2 class="m-0 mt-2" style="font-family: 'Outfit'; font-weight: 700; font-size: 2rem; color: var(--text-main); letter-spacing: -0.5px;">Create Purchase Order</h2>
        </div>
    </div>
                ...
                <div class="glass-form-card h-100">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="date" name="expected_date" class="form-control form-glass" style="padding-left: 42px;" value="{{ old('expected_date') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="position-relative">
                            ...
                            <textarea name="notes" class="form-control form-glass" style="padding-left: 42px; padding-top: 14px;" rows="3" placeholder="Internal notes...">{{ old('notes') }}</textarea>
                        </div>
                    </div>
            ...
            <div class="col-lg-8">
                        ...
                        <div class="row g-3 item-row po-item align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="position-relative">
                                    ...
                                    <input type="number" name="items[0][quantity]" class="form-control form-glass item-qty" style="padding-left: 42px; font-family: 'Outfit'; font-weight: 700;" required min="1" placeholder="0" oninput="updateTotal()">
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="position-relative">
                                    ...
                                    <input type="number" step="0.01" name="items[0][unit_cost]" class="form-control form-glass item-cost" style="padding-left: 42px; font-family: 'Outfit'; font-weight: 700;" required min="0" placeholder="0.00" oninput="updateTotal()">
                                </div>
                            </div>
                            <div class="col-md-1 d-flex align-items-end">
                                <button type="button" class="remove-row-btn" onclick="removeItem(this)" style="visibility: hidden;">
                ...
                <div class="d-flex justify-content-end mb-5">
                    <button type="submit" class="btn btn-primary d-flex justify-content-center align-items-center gap-2" style="height: 54px; padding: 0 40px; font-size: 1.1rem; border-radius: 12px; box-shadow: 0 8px 20px rgba(99,102,241,0.3);">
                        <i data-feather="save"></i> Save Purchase Order
                    </button>
                </div>
            </div>
        </div>
