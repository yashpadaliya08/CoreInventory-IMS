...
<div class="fade-in">
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            <a href="{{ route('receipts.show', $receipt) }}" class="text-muted text-decoration-none fw-bold" style="font-size: 0.85rem;"><i data-feather="arrow-left" style="width: 14px;"></i> Back to Document</a>
            <h2 class="m-0 mt-2" style="font-family: 'Outfit'; font-weight: 700; font-size: 2rem; color: var(--text-main); letter-spacing: -0.5px;">Edit Receipt {{ $receipt->reference_no }}</h2>
        </div>
    </div>
                ...
                <div class="glass-form-card">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="text" name="vendor_name" class="form-control form-glass" style="padding-left: 42px;" value="{{ old('vendor_name', $receipt->vendor_name) }}">
                        </div>
                    </div>
                    
                    <div class="mb-5">
                        <label class="form-label text-muted" style="font-size: 0.75rem; font-weight: 700; text-transform: uppercase;">Expected Arrival Date</label>
                        <div class="position-relative">
                            <i data-feather="calendar" style="position: absolute; top: 14px; left: 14px; color: var(--text-muted); width: 18px;"></i>
                            <input type="date" name="expected_date" class="form-control form-glass" style="padding-left: 42px;" value="{{ old('expected_date', $receipt->expected_date ? \Carbon\Carbon::parse($receipt->expected_date)->format('Y-m-d') : '') }}">
                        </div>
                    </div>
